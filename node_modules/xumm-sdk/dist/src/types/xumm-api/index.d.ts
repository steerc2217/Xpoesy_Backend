...
declare const XrplTxTypes: readonly ["Payment", "OfferCreate", "OfferCancel", "EscrowFinish", "EscrowCreate", "EscrowCancel", "DepositPreauth", "CheckCreate", "CheckCash", "CheckCancel", "AccountSet", "PaymentChannelCreate", "PaymentChannelFund", "SetRegularKey", "SignerListSet", "TrustSet", "EnableAmendment", "AccountDelete", "SetFee"];
...
export declare type XummCancelReason = 'ALREADY_CANCELLED' | 'ALREADY_RESOLVED' | 'ALREADY_OPENED' | 'ALREADY_EXPIRED';
